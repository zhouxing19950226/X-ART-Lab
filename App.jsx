  ...
  return <article className="swiss-reader">
    ...
    <main className="swiss-reader-scroll">
      ...
      <section className="swiss-reader-body">
        ...
        <footer className="swiss-article-footer"><img src="https://zhou-xing.com/logo.png" alt="官网 Logo"/><div className="swiss-footer-copy"><span className="swiss-footer-title">{item[lang][0]}</span><span className="swiss-footer-site">ZHOU-XING.COM</span></div></footer>
      </section>
    </main>
  </article>
}
