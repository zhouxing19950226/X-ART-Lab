...
export async function onRequestPost({request,env}){
  ...
  try{
    const result=await env.AI.run("@cf/zai-org/glm-4.7-flash",{messages:[{role:"system",content:"You help artists convert critical reading into clear understanding and responsible creative practice."},{role:"user",content:prompt}],max_tokens:900,temperature:.45});
